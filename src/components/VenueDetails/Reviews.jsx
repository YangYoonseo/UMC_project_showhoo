...
const Reviews = () => {
  ...
  const [reviews, setReviews] = useState([
    ...
    },
    {
      ...
      profileName: '김지서',
      rating: 4,
      reviewText: '사장님이 살짝 불친절하셨지만 공연장 시설은 좋았습니다. 시설 괜찮은 소규모 공연장 찾기 힘든데 만족스럽습니다.',
  ...
  return (
    <div className="venue-reviews">
      <div className="reviews-header">
        <h2 className="reviews-title">후기 {reviews.length}개 · 평균 평점 <span className="average-rating">{averageRating.toFixed(1)}</span></h2>
        ...
        <div className="review-input-container">
          ...
          ></textarea>
          <button className="submit-button" onClick={handleReviewSubmit}>등록</button>
        </div>
