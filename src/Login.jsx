            ...
            <div className="loginBack">
                <div className="loginBox">
                    <div className="loginTitle">
                        <div><span style={{color:"aquamarine"}}>ShowHoo</span> 에 오신 걸</div>
                        <br/>
                        <div>환영합니다</div>
                    </div>
                    <img className='kakaoButton' src={kakao} alt="카카오 로그인 이미지" onClick={handleLogin}/>
                    <div className="agree" onClick={handletest}>쇼호 서비스 약관</div>
                    <div className="agree" onClick={handleLogout}>쇼호 개인정보 처리방침</div>
                </div>    
            </div>
        </div>
    );
